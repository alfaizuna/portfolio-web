  ...
  return (
    <section id="skills" className="w-full relative">
      <div className="flex flex-col w-full items-center gap-8 sm:gap-12 px-4 sm:px-8 md:px-16 lg:px-[120px] py-12 sm:py-20 relative flex-[0_0_auto] bg-[linear-gradient(180deg,rgba(158,56,94,0)_0%,rgba(158,56,94,0.1)_100%)]">
        <div className="flex flex-col w-full max-w-[847px] items-center gap-4 relative flex-[0_0_auto] px-4">
          <div className="relative text-center text-2xl sm:text-3xl md:text-4xl font-bold text-[#0a0d12] leading-tight">
        ...
        <div className="inline-flex flex-col items-center gap-6 sm:gap-8 relative flex-[0_0_auto]">
          <div className="w-full max-w-[1200px] overflow-hidden relative px-4 sm:px-0">
            ...
            >
              {technologyData.map((tech, index) => {
                // Debug: Ensure HTML (index 0) and CSS (index 1) are first in mobile
                // console.log(`Card ${index}: ${tech.name}`); // Debug log
                return (
                <Card
                  key={index}
                ...
                >
                  <CardContent className="p-0 flex flex-col items-center gap-4 sm:gap-4 h-full justify-between sm:justify-center">
                    ...
                    <div className="flex flex-col items-center gap-3 sm:gap-3 relative self-stretch w-full flex-1 sm:flex-initial justify-center">
          ...
          <div className="inline-flex items-center gap-3 sm:gap-4 relative flex-[0_0_auto]">
            <Button
              variant="outline"
              size="icon"
